<?php
// Arquivo de validação de acessos a plataforma
session_start();
ob_start();
...
if ($btnLogin) {
    ...
    $_SESSION['msg'] = "<div class='alert alert-danger' style='font-size: 0.8em;text-align: center;'>Página não encontrada</div>";
    header("Location: login.php");
}
